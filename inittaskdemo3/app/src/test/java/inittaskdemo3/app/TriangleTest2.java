...
class TriangleTest2 {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/三角形一般边界测试用例.csv",numLinesToSkip =1,encoding = "GB2312")
    ...
    @DisplayName(value="三角形健壮性最坏边界测试用例")
    @ParameterizedTest
    @CsvFileSource(resources = "/三角形健壮性最坏边界测试用例.csv",numLinesToSkip =1,encoding = "GB2312")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/三角形健壮性边界测试用例.csv",numLinesToSkip =1,encoding = "GB2312")
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/三角形弱一般等价类测试用例.csv",numLinesToSkip =1,encoding = "GB2312")
    ...
    @DisplayName(value="三角形最坏边界测试用例")
    @ParameterizedTest
    @CsvFileSource(resources = "/三角形最坏边界测试用例.csv",numLinesToSkip =1,encoding = "GB2312")
